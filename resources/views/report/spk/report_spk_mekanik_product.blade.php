    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title mb-4">Export Rata-rata Waktu Pengerjaan Mekanik per Produk</h5>
                        <form method="GET" action="{{ route('report.spk.export_avg_mekanik_product') }}" class="space-y-4">
