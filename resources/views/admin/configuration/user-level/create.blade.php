    ...
    <x-slot name="header">
        <div>
            <h2 class="font-bold text-2xl text-gray-800 dark:text-gray-200 leading-tight flex items-center">
                ...
                Tambah User Level Baru
            </h2>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                <a href="{{ route('admin.configuration.index') }}" class="text-blue-600 hover:underline">Configuration</a> / 
                <a href="{{ route('admin.configuration.user-level.index') }}" class="text-blue-600 hover:underline">Master User Level</a> / Tambah
            </p>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 p-6">
                <form action="{{ route('admin.configuration.user-level.store') }}" method="POST">
                    @csrf

                    <!-- Kode -->
                    <div class="mb-6">
                        <label for="kode" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                            Kode user-level <span class="text-red-500">*</span>
                        </label>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="nama" id="nama" value="{{ old('nama') }}" required
                               placeholder="Contoh: Factory, Human Capital & General Affairs"
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="3"
                                  placeholder="Deskripsi singkat tentang user-level..."
                    ...
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Hanya user-level aktif yang dapat dipilih saat menambah user</p>
                    </div>
