<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Report Rata-rata Waktu Kerja Mekanik') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title mb-4">Export Rata-rata Waktu Kerja Mekanik</h5>
                        <form method="GET" action="{{ route('report.spk.export_avg_mekanik') }}" class="space-y-4">
