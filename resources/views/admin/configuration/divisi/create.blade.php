    ...
    <x-slot name="header">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                ...
                <a href="{{ route('admin.configuration.divisi.index') }}" class="text-blue-600 hover:underline">Master Divisi</a> / Tambah
            </p>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 p-6">
                <form action="{{ route('admin.configuration.divisi.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Hanya divisi aktif yang dapat dipilih saat menambah user</p>
                    </div>
